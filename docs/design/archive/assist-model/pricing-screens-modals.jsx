  ...
  return (
    <div style={{ width: 340, height: 735, background: PX.paper, padding: '48px 0 0', fontFamily: PX.sans }}>
      ...
      <div style={{ padding: '4px 16px' }}>
        {[
          { topic: topicVar('pine'), t: '7:42 pm', body: 'The pear tree finally fruited. Three pears, the size of fists.' },
          { topic: topicVar('clay'), t: '12:15 pm', body: 'Tomato seedlings outgrowing the windowsill — ready to move out.' },
          { topic: topicVar('amber'), t: '9:02 am', body: 'Idea: the watch should auto-stop on wrist-off. Never lose a recording.' },
        ].map((e, i) => (
          <div key={i} style={{
    ...
    <div style={{ width: 340, height: 735, background: PX.paper, padding: '48px 0 0', fontFamily: PX.sans }}>
      <div style={{ padding: '8px 18px 0' }}>
        ...
        <div style={{ background: PX.card, border: '1px solid ' + PX.hairline, borderRadius: 14, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 10, opacity: 0.6 }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: PX.accent, color: PX.accentInk, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
            <Spark size={18}/>
          </div>
          <div>
    ...
    <PhoneScreen statusDark={false}>
      <Sheet behind={<BehindToday/>} height="80%">
        <div style={{ padding: '14px 22px 28px', display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div style={{
            width: 36, height: 36, borderRadius: 10, background: PX.accent, color: PX.accentInk,
          ...
          {/* Option B: Plus */}
          <button style={{
            background: PX.ink, color: PX.accentInk, border: 'none', borderRadius: 14,
  ...
  return (
    <PhoneScreen>
      ...
      <div style={{ padding: '12px 14px 0', overflow: 'hidden' }}>
        {[
          { topic: topicVar('pine'), t: '7:42 pm', body: 'The pear tree finally fruited. Three pears, the size of fists, hidden behind the leaves.' },
          { topic: topicVar('clay'), t: '12:15 pm', body: 'Tomato seedlings outgrowing the windowsill — ready to move out.' },
          { topic: topicVar('amber'), t: '9:02 am', body: 'Idea: the watch should auto-stop on wrist-off. Never lose a recording.' },
          { topic: topicVar('slate'), t: 'Yesterday', body: 'The library smelled of old wood today. Marigolds on the front desk.' },
        ].map((e, i) => (
          <div key={i} style={{
            background: PX.card, border: '1px solid ' + PX.hairline, borderRadius: 14,
            padding: '12px 14px', marginBottom: 8,
  ...
  return (
    <PhoneScreen>
      <Sheet behind={<BehindMemoryWithAI/>} height="68%">
        <div style={{ padding: '14px 22px 26px', display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div style={{
            width: 32, height: 32, borderRadius: 9, background: PX.warnTint, color: PX.warnInk,
    ...
    <div style={{
      ...
      {tag && (
        <span style={{
          ...
          background: PX.accent, color: PX.accentInk, fontSize: 9.5, fontWeight: 700,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: featured ? PX.accentInk : PX.accent, display: 'flex', alignItems: 'center', justifyContent: 'center',
      }}>
        <Spark size={20}/>
      </div>
  ...
  return (
    <PhoneScreen>
      ...
      <div style={{ padding: '12px 18px 28px', overflow: 'auto', flex: 1 }}>
        <div style={{
          background: PX.ink, color: PX.accentInk, borderRadius: 18, padding: '22px 20px',
          ...
          {closed ? (
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ width: 6, height: 6, borderRadius: 3, /* TODO(dark-mode): founders gold needs dark counterpart */ background: '#FFCE9A' }}/>
