              ...
              <ListRow icon={<Spark size={13}/>} title="Pause AI for this memory"
                ...
                value={
                  <span style={{
                    ...
                    <span style={{ position: 'absolute', left: 2, top: 2, width: 16, height: 16, borderRadius: 8, background: PX.card, boxShadow: PX.shadowCard }}/>
                  </span>
                }
              />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
        {[
          ...
          <div key={i} style={{ display: 'flex', gap: 9, alignItems: 'center', padding: '2px 0', fontSize: 12.5, opacity: 0.92 }}>
            {/* TODO(dark-mode): founders gold needs dark counterpart */}
