// HiMem · App Store marketing frames — V2 (June 15 2026)
// Memory-preservation positioning (the "things you don't want to forget"
// emotional category), per the three-phase model:
//   Phase 1 ships now · Phase 2 emerges over time · Phase 3 = Studio (later).
// Every caption promises only what the screen demonstrates on day one.
// Studio stays OFF the launch page; the close is data custody (true today).
//
//   Frame 1 — Watch capture          "Catch the thought before it's gone."
//   Frame 2 — Memory detail           "Save it now. Keep it for good."
//   Frame 3 — Today / Memories        "Find it again — today, or years from now."
//   Frame 4 — Photo memory            "Photos tell you what. Memories tell you why."
//   Frame 5 — Project · Find thread   "Rediscover what connects."
//   Frame 6 — Data custody (close)    "Yours. In your iCloud."
  ...
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        ...
        <div className="headline" style={{ fontSize: 58 }}>Save it now.<br/>Keep it for good.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 470 }}>
          Get the thought down while it's fresh — a few words, a voice note, a photo. HiMem keeps it, organizes it for you, and hands it back whenever you go looking.
        </div>
      </div>
      ...
      <DrawnPhone style={{ top: 470 }}>
        <div style={{ padding: '6px 20px 0', fontFamily: C.sans, display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ fontFamily: C.serif, fontSize: 26, fontWeight: 600, lineHeight: 1.1, letterSpacing: -0.4, color: C.ink }}>Maren's cooking ideas collection</div>
          ...
          <div style={{ fontSize: 15.5, lineHeight: 1.45, color: C.ink, marginTop: 9, letterSpacing: -0.1 }}>
            Identified a collection of culinary ideas linked to Maren's recent kitchen inspiration — tomato oil, shrimp hush puppies with remoulade, za'tar vinaigrette, and espresso-sugar creme brulee toppings.
          </div>
          ...
          <div style={{ background: C.card, border: '1px solid ' + C.hair, borderRadius: 16, padding: '14px 15px' }}>
            ...
            <div style={{ fontSize: 14.5, lineHeight: 1.5, color: C.ink, letterSpacing: -0.05 }}>
              This is a collection of cooking ideas that Maren sort of collected today or the past couple days. It's these kind of things that really lead her innovation and drive in the kitchen.
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12, color: C.ink3 }}>
              {G.play}<span style={{ fontSize: 12.5 }}>Original recording</span>
            </div>
  ...
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        ...
        <div className="headline" style={{ fontSize: 58 }}>Find it again —<br/>years from now.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 470 }}>
          Everything you've kept, by the day it happened. Search a word, a person, a place — and the moment comes back. No streaks, no nudges.
        </div>
      </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Frame 4 — Photo memory · "what happened / why it mattered"
// The emotional anchor of the set. A photo memory with the owner's own voice
// note giving the WHY — honest: photo + voice + context all ship today.
// ─────────────────────────────────────────────────────────────────────────────
function Frame4() {
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        <div className="eyebrow" style={{ marginBottom: 14 }}>Voice, photo, video, text</div>
        <div className="headline" style={{ fontSize: 54 }}>The story behind<br/>the moment.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 480 }}>
          Say why it mattered while you still remember — HiMem keeps the recording in your own voice, and a photo alongside it if you have one.
        </div>
      </div>
      ...
      <DrawnPhone style={{ top: 470 }}>
        <div style={{ padding: '6px 20px 0', fontFamily: C.sans, display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          {/* the photo — soft drawn scene (placeholder marketing imagery) */}
          <div style={{ height: 196, borderRadius: 16, overflow: 'hidden', position: 'relative', marginBottom: 16, border: '1px solid ' + C.hair }}>
            <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg, #Bc0 0%, #B7C4CE 0%, #D8DCDC 52%, #EDE7DC 52%, #F2ECE0 100%)' }}/>
            {/* distant ridgeline */}
            <svg width="100%" height="100%" viewBox="0 0 340 196" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0 }}>
              <path d="M0 104 L60 78 L120 96 L190 64 L250 90 L300 72 L340 88 L340 102 L0 102 Z" fill="#A7B6BE" opacity="0.6"/>
              <path d="M0 110 L70 92 L150 108 L210 86 L290 104 L340 94 L340 104 L0 104 Z" fill="#93A6AE" opacity="0.7"/>
            </svg>
            {/* soft winter sun */}
            <div style={{ position: 'absolute', top: 30, right: 54, width: 44, height: 44, borderRadius: 22, background: 'radial-gradient(circle, rgba(255,250,240,0.95) 0%, rgba(255,247,233,0.35) 60%, transparent 72%)' }}/>
            {/* foreground snow sweep */}
            <svg width="100%" height="100%" viewBox="0 0 340 196" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0 }}>
              <path d="M0 132 Q120 116 200 138 T340 134 L340 196 L0 196 Z" fill="#F4EFE6"/>
              <path d="M0 150 Q140 138 230 158 T340 150 L340 196 L0 196 Z" fill="#FBF7EF"/>
            </svg>
          </div>

          <div style={{ fontFamily: C.serif, fontSize: 25, fontWeight: 600, lineHeight: 1.12, letterSpacing: -0.4, color: C.ink }}>Stowe, the morning it snowed</div>
          <div style={{ fontSize: 13, color: C.ink3, marginTop: 9 }}>Dec 14 · 7:02 AM · Stowe, Vermont</div>

          {/* SUMMARY — the "what", AI blue eyebrow */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 18 }}>
            {G.spark(C.ai)}
            <span style={{ fontSize: 11.5, fontWeight: 700, letterSpacing: 1.4, textTransform: 'uppercase', color: C.ai }}>Summary</span>
          </div>
          <div style={{ fontSize: 15.5, lineHeight: 1.45, color: C.ink, marginTop: 9, letterSpacing: -0.1 }}>
            The first real snow of the trip, photographed from the cabin porch before anyone else was awake.
          </div>

          {/* the voice clip — the "why", in the owner's own words */}
          <div style={{ background: C.card, border: '1px solid ' + C.hair, borderRadius: 16, padding: '14px 15px', marginTop: 18 }}>
            <div style={{ fontSize: 12, color: C.ink3, fontWeight: 600, marginBottom: 8 }}>Sat Dec 14 · 7:02 AM</div>
            <div style={{ fontSize: 15, lineHeight: 1.5, color: C.ink, letterSpacing: -0.05 }}>
              I wanted to remember how quiet it was — just the snow coming down and the whole valley still asleep. Nobody up but me and the coffee.
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12, color: C.ink3 }}>
              {G.play}<span style={{ fontSize: 12.5 }}>Original recording</span>
            </div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
            <TopicChip label="Travel" color="#9A4D2E"/>
          </div>
  ...
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        ...
        <div className="headline" style={{ fontSize: 58 }}>Rediscover<br/>what connects.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 470 }}>
          HiMem reads across a project and pulls out the thread running through it — plus other memories that may belong.
        </div>
      </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Frame 7 — Search · "Remember more than the moment."
// Rediscovery shown literally: a query, and the moment comes back.
// ─────────────────────────────────────────────────────────────────────────────
function Frame7() {
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        <div className="eyebrow" style={{ marginBottom: 14 }}>Search</div>
        <div className="headline" style={{ fontSize: 56 }}>Remember more<br/>than the moment.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 480 }}>
          Search a name, a place, a feeling — and the memory comes back, in the words you said it in.
        </div>
      </div>
      ...
      <DrawnPhone style={{ top: 470 }}>
        <div style={{ padding: '8px 18px 0', fontFamily: C.sans }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            <span style={{ flex: 1, display: 'inline-flex', alignItems: 'center', gap: 9, height: 42, padding: '0 13px', borderRadius: 12, background: C.card, border: '1px solid ' + C.hair }}>
              {G.search}
              <span style={{ fontSize: 16, color: C.ink, letterSpacing: -0.1 }}>Savannah</span>
              <span style={{ width: 2, height: 19, background: C.accent, borderRadius: 1 }}/>
            </span>
            <span style={{ fontSize: 15, color: C.accent, fontWeight: 500 }}>Cancel</span>
          </div>

          <div style={{ fontSize: 12.5, color: C.ink3, fontWeight: 600, letterSpacing: 0.3, marginBottom: 12 }}>3 MEMORIES</div>
          ...
          <MemoryCardMini
            ...
            audio={2} photo={3}
            topic="Travel" topicColor="#9A4D2E"
            ai gist="Walking the squares at dusk in Savannah — you said it was the calmest you'd felt all year." />
          <MemoryCardMini
            title="Dad's stories from the road"
            time="Mar 22 · 5:09 PM"
            audio={5}
            topic="Family" topicColor="#7A4E8C"
            ai gist="He talked about driving through Savannah in '78 — the heat, the oak trees, the diner that's still there." />
          <MemoryCardMini
            title="Where to go next spring"
            time="Feb 11 · 9:31 AM"
            note={1}
            topic="Travel" topicColor="#9A4D2E"
            gist="“Savannah again, maybe Charleston — somewhere warm and slow.”" />
        </div>
      </DrawnPhone>
    </div>
  );
...
// ─────────────────────────────────────────────────────────────────────────────
// Frame 8 — Onboarding · "No account. No password."
// The trust/zero-friction frame. Sign in with Apple, nothing else asked.
// ─────────────────────────────────────────────────────────────────────────────
function Frame8() {
  return (
    <div className="frame">
      <div className="top-text" style={{ top: 70 }}>
        ...
        <div className="headline" style={{ fontSize: 58 }}>No account.<br/>No password.</div>
        <div style={{ marginTop: 22, fontSize: 18, lineHeight: 1.45, color: C.ink2, maxWidth: 480 }}>
          One tap with Apple and you're in. No email to verify, nothing for us to store. Your name comes from Apple — we never ask twice.
        </div>
      </div>

      <DrawnPhone style={{ top: 470 }}>
        <div style={{ padding: '0 26px', fontFamily: C.sans, height: '100%', display: 'flex', flexDirection: 'column' }}>
          <div style={{ flex: 1 }}/>

          {/* wordmark + tagline */}
          <div style={{ textAlign: 'center', marginBottom: 30 }}>
            <div style={{ fontFamily: C.serif, fontSize: 40, fontWeight: 500, letterSpacing: 0.5, color: C.ink }}>HiMem</div>
            <div style={{ fontFamily: C.serif, fontSize: 19, fontStyle: 'italic', color: C.ink3, marginTop: 8 }}>Remember more of your life.</div>
          </div>

          {/* three quiet value beats */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 34, padding: '0 6px' }}>
            {[
              ['Capture first, organize later.', 'Voice, photo, or a note — phone or Watch.'],
              ['AI suggests, you decide.', 'A draft title and summary you can keep or change.'],
              ['Your memories stay yours.', 'Synced privately through your own iCloud.'],
            ].map(([h, b], i) => (
              <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                <span style={{ width: 22, height: 22, borderRadius: 11, background: C.accentTint, color: C.accent, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1 }}>
                  <svg width="11" height="11" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M2 7.5l3.2 3.2L12 4"/></svg>
                </span>
                <div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: C.ink, letterSpacing: -0.15 }}>{h}</div>
                  <div style={{ fontSize: 13, color: C.ink3, marginTop: 2, lineHeight: 1.4 }}>{b}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Sign in with Apple */}
          <div style={{ height: 54, borderRadius: 14, background: C.ink, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 9 }}>
            <svg width="18" height="20" viewBox="0 0 18 20" fill="#fff"><path d="M14.6 10.7c0-2.3 1.9-3.4 2-3.5-1.1-1.6-2.8-1.8-3.4-1.8-1.4-.15-2.8.85-3.5.85-.7 0-1.85-.83-3-.81-1.55.02-2.98.9-3.78 2.29-1.6 2.8-.41 6.95 1.15 9.23.76 1.11 1.67 2.36 2.86 2.31 1.15-.05 1.58-.74 2.97-.74 1.38 0 1.77.74 2.98.72 1.23-.02 2.01-1.13 2.76-2.25.87-1.29 1.23-2.54 1.25-2.6-.03-.01-2.4-.92-2.42-3.66zM12.3 3.7c.63-.77 1.06-1.83.94-2.9-.91.04-2.01.61-2.67 1.37-.59.68-1.11 1.76-.97 2.8 1.02.08 2.06-.51 2.7-1.27z"/></svg>
            <span style={{ fontSize: 17, fontWeight: 600, letterSpacing: -0.2 }}>Sign in with Apple</span>
          </div>
          <div style={{ fontSize: 12.5, color: C.ink3, textAlign: 'center', marginTop: 14, lineHeight: 1.5 }}>
...
Object.assign(window, { Frame1, Frame2, Frame3, Frame4, Frame5, Frame6, Frame7, Frame8 });
