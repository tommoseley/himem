...
// Topic chip — small, top of content. Pass `slug` matching the 10-swatch
// Crucible topic palette (see palette spec); falls back to ink3 if absent.
      ...
      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
        {items.map(([label, slug], i) => (
          <span key={i} style={{
            ...
            <span style={{ width: 6, height: 6, borderRadius: 3, background: slug ? topicVar(slug) : PX.ink3 }}/>
            {label}
          </span>
        ))}
      </div>
