...
## P7 · Clips filter cycle — New·All·Loose + top-ordering + source-glyph write-side (July 18 2026)

**Spec source:** `Captured Clips · session-first · spec.md` § "Clip lifecycle + the status lens" and § "Loose-clip cleanup" (locked July 18 2026); `CLAUDE.md` § Phone (status axis redefined). One coherent cycle — the dogfood Clips screen (9-screenshot set, July 18) exposed all of these together.
