...
function MemoryFAB() {
  return (
    <div style={{
      ...
      boxShadow: '0 6px 18px rgba(198,74,28,0.30), 0 2px 4px rgba(0,0,0,0.10)',
    }}>
...
function ClipImage({ time }) {
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute', left: 8, bottom: 6, fontSize: 11, color: '#fff',
  ...
  return (
    <div style={{
        ...
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          {['Product idea', 'Content tools', 'Multi-device'].map(t => (
            <span key={t} style={{
              ...
              padding: '3px 9px 3px 7px', borderRadius: 10, background: 'rgba(26,22,18,0.05)',
            }}>
      ...
      <div style={{
        ...
        <button style={{
          flex: 1, background: PX.ink, color: '#FFFCF6', border: 'none', borderRadius: 9,
...
function StaleFooter({ exhausted = false, resetDate = 'Jun 1' }) {
  return (
    <div style={{
      ...
      fontSize: 12, color: '#7A4A0E', letterSpacing: -0.05, marginTop: 10,
    }}>
      <span style={{ color: '#7A4A0E', flexShrink: 0, marginTop: 1 }}><Spark size={12}/></span>
      ...
      <span style={{
        flexShrink: 0, fontSize: 11, fontWeight: 600, color: exhausted ? PX.ink3 : '#7A4A0E',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <Row
          inputs={[
            { k: 'stale', v: 'true' },
            { k: 'assists', v: '0', color: '#B8311E', dim: true },
          ]}
...
function ScrJournalView() {
  const TG = '#2F9E6B'; // garden
  const TI = '#C08A1F'; // ideas
  const TW = '#4A5C6E'; // work
  return (
    <PhoneScreen>
  ...
  const Eg = ({ good = false, bad = false, label, text }) => (
    <div style={{
      ...
      <div style={{
        ...
        color: good ? PX.confirmed : (bad ? '#B8311E' : PX.ink3),
        marginBottom: 6,
      }}>{label}</div>
      <div style={{
        ...
        textDecorationColor: 'rgba(184,49,30,0.5)',
        letterSpacing: -0.05,
      }}>{text}</div>
    </div>
  );
