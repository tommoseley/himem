...
const SPEC = {
  paper: '#FFFCF6',
  ink: '#1A1612',
  ink2: 'rgba(26,22,18,0.66)',
  ink3: 'rgba(26,22,18,0.45)',
  ink4: 'rgba(26,22,18,0.22)',
  hairline: 'rgba(26,22,18,0.10)',
  ai: '#1E5C8E',
  aiTint: 'rgba(30,92,142,0.10)',
  confirmed: '#3FA877',
  warn: '#B87322',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: '#fff', border: '1px solid ' + SPEC.hairline, borderRadius: 14,
        padding: '14px 16px',
      }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <span style={{
            ...
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
